...
- (CGFloat)waterfallLayout:(CustomWaterfallLayout *)waterfallLayout itemHeightForWidth:(CGFloat)itemWidth atIndexPath:(NSIndexPath *)indexPath;
...
//代理，用来计算item的高度
@property (nonatomic, weak) id<CustomWaterfallLayoutDelegate> delegate;
